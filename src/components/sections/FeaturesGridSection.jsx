    ...
    >
      <div className="max-w-275 mx-auto px-6">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <span className="dash-badge dash-badge-orange mb-4 inline-flex">
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Title */}
              <h3
                className="font-heading font-semibold text-breathe-text-primary mb-2"
              ...
              {/* Description */}
              <p
                className="text-breathe-text-secondary"
                style={{ fontSize: "clamp(13px, 1vw, 15px)", lineHeight: 1.6 }}
              >
                {feature.description}
              </p>
            </div>
