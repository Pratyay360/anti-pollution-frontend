...
export default function FeatureSection({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Title entrance
      scrollTl.fromTo(titleEl, { y: "6vh", opacity: 0 }, { y: 0, opacity: 1, ease: "none" }, 0.1);

      // Body entrance
      scrollTl.fromTo(bodyEl, { y: "5vh", opacity: 0 }, { y: 0, opacity: 1, ease: "none" }, 0.12);
      ...
      if (imagePosition === "right") {
        scrollTl
          .to(card, { x: "-40vw", rotate: 2, opacity: 0.25, ease: "power2.in" }, 0.7)
          .to(imageEl, { x: "40vw", opacity: 0.25, ease: "power2.in" }, 0.7);
      } else {
        scrollTl
          .to(imageEl, { x: "-40vw", opacity: 0.25, ease: "power2.in" }, 0.7)
          .to(card, { x: "40vw", rotate: -2, opacity: 0.25, ease: "power2.in" }, 0.7);
      ...
      scrollTl
        .to(titleEl, { y: "-4vh", opacity: 0.2, ease: "power2.in" }, 0.7)
        .to(bodyEl, { opacity: 0.2, ease: "power2.in" }, 0.7)
        .to(bulletItems, { opacity: 0.2, ease: "power2.in", stagger: 0.01 }, 0.7);
    }, section);
  ...
  const cardContent = (
    ...
    >
      ...
      <div
        ...
        style={{ background: "var(--breathe-accent)" }}
      />
      ...
      <ul ref={bulletsRef} className="space-y-3">
        {bullets.map((bullet, index) => (
          <li key={index} className="flex items-center gap-3">
            ...
            <span
              className="text-breathe-text-primary"
