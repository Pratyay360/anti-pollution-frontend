          ...
          {result === 'success' ? (
            <div className="flex flex-col items-center text-center py-4">
              <div className="w-14 h-14 rounded-full flex items-center justify-center mb-4"
                ...
                <CheckCircle2 className="w-7 h-7" style={{ color: 'var(--breathe-accent)' }} />
              </div>
              <p className="text-xs font-semibold tracking-widest uppercase mb-1" style={{ color: 'var(--breathe-accent)' }}>
                Route found
              </p>
              <h2 className="font-heading font-bold text-breathe-text-primary mb-1" style={{ fontSize: 'clamp(18px, 2vw, 26px)' }}>
                {startingPoint} → {destination}
              </h2>
              <p className="text-breathe-text-secondary text-sm mb-6">
                Optimised for {activeFilters.map(id => FEATURE_PILLS.find(p => p.id === id)?.label).join(', ')}.
              </p>
              <div className="flex gap-3 w-full">
                <button
                  ...
                  style={{ borderColor: 'var(--breathe-border)', color: 'var(--breathe-text-secondary)' }}
                >
                  Plan another
                </button>
                <button
            ...
            <>
              ...
              <div className="space-y-2 mb-5">
                ...
                <div className="flex items-center gap-3 px-5">
                  ...
                  <div className="w-2 h-2 rounded-full" style={{ background: 'var(--breathe-accent)', opacity: 0.4 }} />
                  <div className="w-px flex-1" style={{ background: 'var(--breathe-border)' }} />
                </div>
              ...
              <div ref={pillsRef} className="mt-5">
                ...
                <div className="flex items-center justify-center gap-2 flex-wrap">
                  {FEATURE_PILLS.map(({ id, icon: Icon, label, color, bg, activeBg }) => {
