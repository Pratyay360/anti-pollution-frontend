...
export default function FooterSection() {
  ...
  return (
    <footer
      ...
      style={{
        backgroundColor: "var(--breathe-bg-secondary)",
        borderTop: "1px solid var(--breathe-border)",
      }}
    >
      <div className="max-w-[1100] mx-auto px-6">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.borderColor = "var(--breathe-accent)")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.borderColor = "var(--breathe-border)")
                  }
                >
        ...
        {/* Newsletter */}
        <div ref={newsletterRef} className="breathe-card p-5 lg:p-6 mb-10">
        ...
        <div
          ...
          style={{ borderTop: "1px solid var(--breathe-border)" }}
        >
          <p className="text-breathe-text-secondary text-xs">
          ...
          <div className="flex items-center gap-5">
            {["Privacy", "Terms", "Cookies"].map((l) => (
              <a
                key={l}
                href="#"
                className="text-breathe-text-secondary hover:text-breathe-accent transition-colors duration-200 text-xs"
              >
                {l}
              </a>
            ))}
